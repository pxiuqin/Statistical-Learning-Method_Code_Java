...
public class PCA4EVD {
    public static void main(String[] args) {
        ...
        INDArray temp = hao.dup();
        System.out.println(PCA.pca(temp, 1, true));
    ...
    public INDArray pca(INDArray X) {
        ...
        //3、求散度矩阵:X^T*X
        INDArray scatter = norm.transpose().mmul(norm);   //covarianceMatrix(X)[0];
        ...
        //7、生成一个新data
        return X.mmul(feature.reshape(X.columns(),1));
    }

    public static INDArray[] covarianceMatrix2(INDArray in) {
